// URP Terrain/Lit completo con muestreo estocástico para romper el tiling.
Shader "RPG/URP/Terrain Texture Bombing"
{
    Properties
    {
        ...
        _BombingCellScale("Bombing Macro Cell", Range(1, 12)) = 4
        _BombingOffsetStrength("Random Offset", Range(0, 2)) = 1.15
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/_RPG/Shaders/TerrainTextureBombingInput.hlsl"
